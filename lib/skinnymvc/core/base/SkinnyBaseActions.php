...
class SkinnyBaseActions {
   ...
   */
   public function call($module='default', $action='index', $request=array('GET'=>array(), 'POST'=>array())) {
      $moduleClass = SkinnyControllerCrm::camelize($module) . 'Actions';

      $actionMethod = 'execute'.SkinnyControllerCrm::camelize($action);
   ...
   */
   ...
   {
     SkinnyBaseControllerCrm::setLayout($layout);
   }
