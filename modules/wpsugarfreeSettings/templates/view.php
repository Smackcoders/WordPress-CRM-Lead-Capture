	...
	<table  class="settings-table">
		...
		<tr>
			<td style='width:160px;'>
				<label id="innertext"> Sugar Host Address </label><div style='float:right;'> : </div>
			</td>
			<td>
		...
		<tr>
			<td style='width:160px;'>
				<label id="innertext"> Sugar Username </label><div style='float:right;'> : </div>
			</td>
			<td>
		...
		<tr>
			<td style='width:160px;'>
				<label id="innertext"> Sugar Password </label><div style='float:right;'> : </div>
			</td>
			<td>
